...
public class GameSnake {
    ...
    final int START_SHAKE_SIZE = 6;
    final int START_SHAKE_X = 10;
    final int START_SHAKE_Y = 10;
    ...
    void go() {
        frame = new JFrame(TITLE_OF_PROGRAM + " : " + START_SHAKE_SIZE);
        ...
        snake = new Snake(START_SHAKE_X,START_SHAKE_Y,START_SHAKE_SIZE,START_DIRECTION);
        food = new Food();
        while (!gameOver) {
            snake.move();
            if (food.isEaten()) {
